...
# ----------------------------------------------------------------------------------------
try:
    data = pd.read_csv('/Users/computer/Desktop/100_days_of_python_pledge/Day31/flash-card-project-start/data/french_words.csv')
except FileNotFoundError:
    original_data = pd.read_csv('/Users/computer/Desktop/100_days_of_python_pledge/Day31/flash-card-project-start/data/french_words.csv')
...
def next_card():
    ...
    flip_timer = window.after_cancel(3000, func=flip_card)
...
card_back_img = PhotoImage(file='/Users/computer/Desktop/100_days_of_python_pledge/Day31/flash-card-project-start/images/card_back.png')
